...
TEST( PatchMatchHeise, BruteForceSearch ) {
  ...
  BBox2f search_range(Vector2f(-70,-25),Vector2f(105,46)); // exclusive
  block_write_image( "blog_article/brute_force_cones-D_abs_5.tif",
                     stereo::correlate(left_image, right_image,
                                       stereo::NullOperation(),
                                       search_range, Vector2i(5, 5)),
                     TerminalProgressCallback("test","BruteForce:") );
  block_write_image( "blog_article/brute_force_cones-D_sq_5.tif",
                     stereo::correlate(left_image, right_image,
                                       stereo::NullOperation(),
                                       search_range, Vector2i(5, 5),
                                       stereo::SQUARED_DIFFERENCE),
                     TerminalProgressCallback("test","BruteForce:") );
  block_write_image( "blog_article/brute_force_cones-D_cross_5.tif",
                     stereo::correlate(left_image, right_image,
                                       stereo::NullOperation(),
                                       search_range, Vector2i(5, 5),
                                       stereo::CROSS_CORRELATION),
                     TerminalProgressCallback("test","BruteForce:") ); 
  block_write_image( "blog_article/brute_force_cones-D_abs_LoG_5.tif",
                     stereo::correlate(left_image, right_image,
                                       stereo::LaplacianOfGaussian(1.3),
                                       search_range, Vector2i(5, 5)),
                     TerminalProgressCallback("test","BruteForce:") );
  block_write_image( "blog_article/brute_force_cones-D_abs_SM_5.tif",
                     stereo::correlate(left_image, right_image,
                                       stereo::SubtractedMean(7),
                                       search_range, Vector2i(5, 5)),
                     TerminalProgressCallback("test","BruteForce:") );
  block_write_image( "blog_article/brute_force_cones-D_abs_SM_3.tif",
                     stereo::correlate(left_image, right_image,
                                       stereo::SubtractedMean(7),
