...
CXXFLAGS += -O0 -g -I$(BDIR)/include -I$(BDIR)/include/boost-1_55 -I$(VWDIR)/include -I$(PWD) -I$(ASPDIR)/include -I$(BDIR)/include/eigen3 -Wall -Wno-unused-local-typedefs -DTRILIBRARY #-DDEBUG #-DVW_ENABLE_BOUNDS_CHECK=1 -DDEBUG
CFLAGS += -DTRILIBRARY
...
EXECS = fancy_correlate transform_by_disparity testing testing_patchtvmin ground_truth_gen testing_ARAP
...
fancy_correlate : fancy_correlate.o PatchMatch2Heise.o SurfaceFitView.o PatchMatch2NCC.o TVMin3.o
