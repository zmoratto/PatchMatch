...
CXXFLAGS += -g -DDEBUG -O1 -I$(BDIR)/include -I$(BDIR)/include/boost-1_55 -I$(VWDIR)/include -I$(PWD) -ffast-math -Wall -Wno-unused-local-typedefs -DVW_ENABLE_BOUNDS_CHECK=1
