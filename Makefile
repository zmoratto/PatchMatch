...
CXXFLAGS += -O2 -g -I$(BDIR)/include -I$(BDIR)/include/boost-1_55 -I$(VWDIR)/include -I$(PWD) -I$(ASPDIR)/include -I$(BDIR)/include/eigen3 -Wall -Wno-unused-local-typedefs -DTRILIBRARY -DDEBUG #-DDISABLE_RL #-DVW_ENABLE_BOUNDS_CHECK=1 -DDEBUG
CFLAGS += -DTRILIBRARY
