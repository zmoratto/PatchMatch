#ifndef __VW_STEREO_PATCHMATCH2NCC_H__
#define __VW_STEREO_PATCHMATCH2NCC_H__
...
namespace vw {
  namespace stereo {
    ...
    public:
      PMNCCBase( BBox2i const& bbox, Vector2i const& kernel,
                      float consistency_threshold, int32 max_iterations );
    };

    template <class Image1T, class Image2T>
    class PMNCCView : public ImageViewBase<PMNCCView<Image1T, Image2T> >, PMNCCBase {
    ...
    public:
      ...
      typedef ProceduralPixelAccessor<PMNCCView> pixel_accessor;

      // Search region values are inclusive.
      PMNCCView( ImageViewBase<Image1T> const& left,
        ...
        PMNCCBase(search_region, kernel_size,
      ...
      inline pixel_type operator()( int32 /*i*/, int32 /*j*/, int32 /*p*/ = 0) const {
        vw_throw( NoImplErr() << "PMNCCView::operator()(....) has not been implemented." );
        return pixel_type();
      }
    ...
    template <class Image1T, class Image2T>
    PMNCCView<Image1T,Image2T>
    patch_match_ncc( ImageViewBase<Image1T> const& left,
                     ImageViewBase<Image2T> const& right,
                     BBox2i const& search_region, Vector2i const& kernel_size,
                     float consistency_threshold = 1,
                     int32 max_iterations = 6 ) {
      typedef PMNCCView<Image1T,Image2T> result_type;
...
#endif//__VW_STEREO_PATCHMATCH2NCC_H__
